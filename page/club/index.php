      ...
      <tbody>
        ...
        <?php foreach($sql as $row): ?>
          <tr>
            ...
            <td><?= $row['club'] ?></td>
            <td>
              <a href="edit.php?id_club=<?= $row['id_club'] ?>" class="btn btn-info btn-sm">Ubah</a>
              <a href="./../../proses/club/delete.php?id_club=<?= $row['id_club'] ?>" class="btn btn-danger btn-sm">Hapus</a>
            </td>
          </tr>
        <?php endforeach ?>
      </tbody>
